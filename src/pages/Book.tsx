...
const Book = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "We finalize the design and budget",
    },
    {
      icon: Hammer,
      title: "Execution Begins",
      description: "Our team starts the renovation work",
    },
    {
      icon: Package,
      title: "Final Installations",
      description: "Quality fixtures and finishing touches",
    },
    {
      icon: Home,
      title: "Move In",
      description: "Your dream space is ready!",
    },
  ];
          ...
          <Card className="text-center">
            <CardContent className="pt-12 pb-12">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Thank you for booking with AVI SANITARY Projects. Our team will contact you shortly to confirm the details.
              </p>
          ...
          <Card className="bg-primary text-primary-foreground">
            ...
            <CardContent className="space-y-6">
              <p className="text-primary-foreground/90">
                Book your appointment directly through WhatsApp for instant confirmation and quick communication with our team.
              </p>
              <Button
